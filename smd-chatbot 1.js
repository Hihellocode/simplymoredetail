// Simply More Detail - AI Booking Bot with Formspree Integration
...
(function() {
    ...
    const chatHTML = `
        ...
        <div id="smd-chat-container">
            ...
            <div class="smd-input-area" id="smd-input">
                <input type="text" id="smd-phone" placeholder="Enter your phone number..." />
    ...
    const userInput = document.getElementById('smd-phone');
    ...
    function askPhone() {
        setTimeout(() => {
            addMessage("Awesome! What's your phone number? We'll text you to confirm your booking slot.");
    ...
    async function submitBooking() {
        try {
            ...
            if (response.ok) {
                setTimeout(() => {
                    addMessage("Perfect! 🚗 Your booking request is confirmed. We'll text you within 2 hours to lock in your time slot!");
